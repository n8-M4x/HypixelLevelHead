...
public class HypixelAPI {
    ...
    public static HypixelAPI INSTANCE = new HypixelAPI(new ApacheHttpClient(UUID.fromString(LevelHead.API_KEY)));
    ...
    public HypixelAPI(HypixelHttpClient httpClient) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            System.out.println("Closing hypixel api");
            HypixelAPI.INSTANCE.shutdown();
        }));
    }
